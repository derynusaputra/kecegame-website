...
export default function ApiKeyPreviewModal({
  isOpen,
  onClose,
  apiKey,
  providerName,
    ...
    >
      <div className="text-center">
        ...
        <p className="mb-6 text-sm leading-6 text-gray-500 dark:text-gray-400">
          Berikut adalah API Key lengkap untuk provider ini. Klik tombol copy
          untuk menyalin ke clipboard.
        </p>

        <div className="mb-6">
          <div className="rounded-lg bg-gray-100 p-4 font-mono text-sm break-all text-gray-700 dark:bg-gray-700 dark:text-gray-300">
            {apiKey}
          </div>
        </div>
        ...
        <div className="flex w-full items-center justify-center gap-3">
          ...
          <Button
            size="sm"
            onClick={handleCopy}
            className="bg-blue-light-500 hover:bg-blue-light-600 text-white"
          >
            {copied ? (
